          ...
          child: Column(
            children: [
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: 'اسم المنطقة', hintStyle: TextStyle(fontFamily: 'Droid',)
                  ),
                  validator: (value){
              ...
              Container(
                ...
                child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'رقم القطعة', hintStyle: TextStyle(fontFamily: 'Droid',)
                    ),
                    validator: (value){
                      if (value.isEmpty || value == null){
              ...
              Container(
                ...
                child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'رقم الشارع', hintStyle: TextStyle(fontFamily: 'Droid',)
                    ),
                    validator: (value){
                      if (value.isEmpty || value == null){
              ...
              Container(
                ...
                child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'رقم المنزل', hintStyle: TextStyle(fontFamily: 'Droid',)
                    ),
                    validator: (value){
                      if (value.isEmpty || value == null){
              ...
              Container(
                ...
                child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'رقم الجادة', hintStyle: TextStyle(fontFamily: 'Droid',)
                    ),
                    validator: (value){
                      if (value.isEmpty || value == null){
              ...
              Container(
                ...
                child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'الدور', hintStyle: TextStyle(fontFamily: 'Droid',)
                    ),
                    validator: (value){
                      if (value.isEmpty || value == null){
              ...
              TextButton(
                  ...
                  child: Text('اضافة العنوان الجديد',style: TextStyle(color: Colors.white,fontFamily: 'Droid', fontSize: 16)),
                  onPressed: () async {
